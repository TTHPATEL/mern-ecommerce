...
export const signupAsync = createAsyncThunk(
  "http://localhost:8000/auth/signupAsync",
  async (cred) => {
...
export const loginAsync = createAsyncThunk(
  "http://localhost:8000/auth/loginAsync",
  async (cred) => {
...
export const verifyOtpAsync = createAsyncThunk(
  "http://localhost:8000/auth/verifyOtpAsync",
  async (cred) => {
...
export const resendOtpAsync = createAsyncThunk(
  "http://localhost:8000/auth/resendOtpAsync",
  async (cred) => {
...
export const forgotPasswordAsync = createAsyncThunk(
  "http://localhost:8000/auth/forgotPasswordAsync",
  async (cred) => {
...
export const resetPasswordAsync = createAsyncThunk(
  "http://localhost:8000/auth/resetPasswordAsync",
  async (cred) => {
...
export const checkAuthAsync = createAsyncThunk(
  "http://localhost:8000/auth/checkAuthAsync",
  async () => {
...
export const logoutAsync = createAsyncThunk(
  "http://localhost:8000/auth/logoutAsync",
  async () => {
